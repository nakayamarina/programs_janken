...
# # 相関マップ（Rock と Scissor）
# ---
# 引数：raw_rock.csv/raw_scissor.csvがあるディレクトリまでのパス
#
# ----
#
# 入力：raw_rock.csv/raw_scissor.csv
#
# ----
#
...
for voxNo in range(voxNum):
    ...
    # 相関を求める
    cor_matrix = np.corrcoef(rockar, scissorar)
...
# csv書き出し
PATH_cormap = PATH + 'correlationmap_RS.csv'
